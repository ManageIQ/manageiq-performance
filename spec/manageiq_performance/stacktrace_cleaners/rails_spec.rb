require "manageiq_performance/stacktrace_cleaners/rails"
  ...
  describe "#call" do
    it "returns the stacktrace without trace including gem info" do
      ...
      expect(subject.call).to eq [
        "spec/manageiq_performance/stacktrace_cleaners/rails_spec.rb:14:in `block (3 levels) in <top (required)>'"
      ]
    end
  end
end
